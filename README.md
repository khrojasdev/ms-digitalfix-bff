...
**Componente:** BFF / API interna  
**Asignatura:** DSY1107 Desarrollo Cloud Native I - Duoc UC  
**Primera entrega (EP1):** 14 de septiembre de 2026

## Descripcion

Backend for Frontend: valida el token, resuelve empresa y roles, y orquesta a los microservicios de dominio.

## Tecnologias

Spring Boot 3, Spring Security (resource server), Spring Data JPA, Oracle, Flyway, OpenFeign
...
- [`ms-digitalfix-bff`](https://github.com/khrojasdev/ms-digitalfix-bff) - BFF / API interna **(este)**
